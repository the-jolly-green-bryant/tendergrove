...
const SafetyPage = () => {
  ...
  return (
    <Page title="Safety & support" backHref="/dashboard" className="safety-page">
      ...
      <FlippableCard className="safety-page__urgent" role="alert" kicker="Immediate danger" title="Call emergency services">
      ...
      <FlippableCard className="safety-page__support" kicker="Need support or help deciding?" title="Talk with a crisis counselor">
      ...
      <FlippableCard
        className="safety-page__plan"
        kicker="For the next hard moment"
        title="My short safety plan"
        description="Keep a few practical details ready. This plan stays on this device and is not monitored."
      >
        <IonCardContent>
          <IonList>
