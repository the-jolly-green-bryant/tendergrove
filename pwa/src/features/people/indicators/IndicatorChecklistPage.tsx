            ...
            <IonHeader translucent>
                <IonToolbar>
                    <IonButtons slot="start">
                        <IonButton fill="clear" onClick={() => router.goBack()} aria-label="Go back">
...
function PolaritySection({
    ...
    return (
        <section className="checklist-section">
            <h2 className="checklist-section__title" style={{ color: `var(--ion-color-${meta.color})` }}>
                {meta.title}
            </h2>
            <IonList lines="none" className="checklist-list">
                {items.map((item) => (
                    <IonItem key={item.id} className="checklist-item">
                        <IonCheckbox
                            slot="start"
                        ...
                        <IonLabel>
                            {item.name}
                            {item.isCustom && (
                                <span className="checklist-custom-badge">Custom</span>
                            )}
                        </IonLabel>
                    </IonItem>
                ))}
