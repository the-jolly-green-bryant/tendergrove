...
import { arrowBackOutline, chevronForwardOutline, informationCircleOutline } from 'ionicons/icons';
    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen className="ion-padding safe-content">
                <h1 className="choose-type__heading">What type of indicator would you like to add?</h1>
                    ...
                    return (
                        ...
                        >
                            <IonCardContent className="choose-type-card__body">
                                <IonIcon icon={meta.icon} color={meta.color} className="choose-type-card__icon" />
                                <div className="choose-type-card__text">
                                    <h2>{meta.title} Indicator</h2>
                                    <p>{meta.blurb}</p>
                                    <p className="choose-type-card__examples">Examples: {meta.examples}</p>
                                </div>
